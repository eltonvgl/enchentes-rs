var frases =[
    ...
    "E quando acaricio a cabeça de meu cão sei que ele não exige que eu faça sentido ou me explique. Clarice Lispector",
    "Mais esperança nos meus passos do que tristeza nos meus ombros. Geraldo Eustáquio de Souza",
    ...
    "Dois homens olharam através das grades da prisão; um viu a lama, o outro as estrelas. Desconhecido",
    ...
    "A vida é mais importante do que a comida, e o corpo, mais do que as roupas. Jesus Cristo",
    "Porque onde estiver o vosso tesouro, aí estará também o vosso coração. Jesus Cristo",
    "O ladrão não vem senão para roubar, matar e destruir; eu vim para que tenham vida e a tenham em abundância. Jesus Cristo",
    "Vinde a mim todos vós que estais cansados e eu vos aliviarei, porque meu jugo é suave e o meu fardo é leve. Jesus Cristo",
    ...
    "Bem-aventurados os que têm fome e sede de justiça, porque serão fartos. Jesus Cristo",
    "Portanto, não vos inquieteis com o dia de amanhã, pois o amanhã trará os seus cuidados; basta ao dia o seu próprio mal. Jesus Cristo",
    "Aquele que crê em mim nunca estará sozinho. Jesus Cristo",
    "Bem-aventurados os mansos, porque eles herdarão a terra. Jesus Cristo",
    "Portanto vigiai, porque não sabeis o dia nem a hora em que o Filho do homem há de vir. Jesus Cristo",
    "A medida do amor é amar sem medida. Santo Agostinho",
    "Necessitamos um do outro, para sermos nós mesmos. Santo Agostinho",
    "Ama a Deus sobre todas as coisas. Jesus Cristo",
    "Pai, perdoa-lhes, porque não sabem o que fazem. Jesus Cristo",
    "Mas buscai primeiro o Reino de Deus, e a sua Justiça, e as demais coisas vos serão acrescentadas. Jesus Cristo",
...
document.getElementById("textoAleatorio").value = frases[Math.floor(Math.random()*frases.length)];
